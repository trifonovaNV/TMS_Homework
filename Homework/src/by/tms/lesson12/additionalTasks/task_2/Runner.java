...
public class Runner {
    ...
    public static void main(String[] args) throws IOException {
        String text = "";
        try (BufferedReader  reader = new BufferedReader(new FileReader("src/by/tms/lesson12/additionalTasks/task_2/input.txt"))){
        ...
        try ( BufferedWriter  writer = new BufferedWriter(new FileWriter("src/by/tms/lesson12/additionalTasks/task_2/output.txt"))){
