...
/*
    ...
    Для предстартовой проверки можете придумать свою логику, главное, что бы метод возвращал true либо false в
 ...
 */
    ...
    public static void main(String[] args) {
        ...
        cosmodrome.starting(new Shuttle());
        cosmodrome.starting(new SpaceX());
        cosmodrome.starting(new SpaceShip());
    }
}
